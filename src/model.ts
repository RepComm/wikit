...
import { Arrays, BufferInfo, createBufferInfoFromArrays, createVertexArrayInfo, m4, primitives, setBuffersAndAttributes, setUniforms, VertexArrayInfo } from "twgl.js";
import { rand } from "./api.js";
import { Matrix } from "./matrix.js";
import { Shader, Uniforms } from "./shader.js";
...
export class InstanceableModel {
  ...
  private _bufferInfoNeedsBuilt: boolean;

  get bufferInfoNeedsBuilt (): boolean {
  ...
  constructor(original?: InstanceableModel, max: number = 100) {
  ...
  copyColorToBuffer (buffer: Float32Array|Array<number>, offset: number = 0) {
  ...
  render (gl: WebGL2RenderingContext, u_viewProjection: Matrix) {
